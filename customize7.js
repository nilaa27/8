document.addEventListener('DOMContentLoaded', function() {
    ...
    async function redrawCanvas() {
        ...
        // --- [MODIFIED] Layout 2x2 untuk 4 foto ---
        const columns = 2, rows = 2; 
        const imageGridSize = rows * columns;
        // --- [MODIFIED] Menyesuaikan tinggi kanvas untuk layout 2x2 ---
        const canvasWidth = 900, canvasHeight = 960;
        ...
        if (storedImages && storedImages.length === imageGridSize) {
            ...
            // --- [MODIFIED] Memperbarui pesan peringatan ---
    ...
    // Catatan: Posisi stiker mungkin perlu disesuaikan secara manual karena tinggi kanvas berubah.
    function drawSticker(ctx, stackedCanvas, stickerType) {
        return new Promise((resolve) => {
           if (!stickerType) return resolve();
           // DATA LENGKAP STIKER ANDA (TIDAK DIUBAH)
    ...
    function downloadFinalImage() {
        ...
        if (isIOS) {
            ...
            link.href = imageData;
            // --- [MODIFIED] Nama file untuk 4 foto ---
            link.download = 'pictlord_4_photos.png';
    ...
    if (controlsPanel) {
        controlsPanel.addEventListener('click', (e) => {
            ...
            if (button.classList.contains('buttonFrames') || button.classList.contains('buttonBgFrames')) {
                ...
                // --- [MODIFIED] Arahkan ke halaman 4 foto ---
